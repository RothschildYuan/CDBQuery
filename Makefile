PROGRAM = libCDBQuery.so             # 最后的可执行文件
...
INCLUDES  = -I ./ -I ./include -I ./src/common -I ./src/sqlConnPool 
INCLUDES += -I ./include-internal -I ./include-internal/mysql -I ./include-internal/postgresql

LIBS  = -L. ./lib/libmysql/libmysqlclient.so
LIBS += -L. ./lib/libpq/libpq.so
